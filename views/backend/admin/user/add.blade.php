      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br />
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action=" {{$base_url}}/auth/signup " method="post">
                <div class="form-group has-feedback">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-username">Username <span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="username" id="first-username" required="required" class="form-control col-md-7 col-xs-12" value="" placeholder="Username">
                  </div>
                ...
                <div class="form-group has-feedback">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="email" name="email" id="first-email" required="required" class="form-control col-md-7 col-xs-12" value="" placeholder="Email">
                  </div>
                        <span class="help-block"></span>
                </div>
                ...
                <div class="form-group has-feedback">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="phone" name="phone" id="first-phone" required="required" class="form-control col-md-7 col-xs-12" value="" placeholder="Telepon">
                  </div>
                        <span class="help-block"></span>
                </div>
