    ...
    <div class="">
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
                <a href="{{ $link.'add' }}" class="btn btn-primary">Tambah Artikel </a>
                <div class="clearfix"></div>
            </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    @foreach($data->data as $key => $datas)
                        <tr>
                            <td> {{ $key+1 }}</td>
                            <td><img src="{{ $datas->thumbnail }}" style="width:70px;heigth:70px" alt="Member Card"></td>
                            <td> {{ $datas->title }} </td>
                            <td> {{ $datas->content }} </td>
                            <td>
                                <a href="{{ $link.$datas->id.'/update' }}" class="btn btn-default btn-sm"><i class="fa fa-edit"></i></a>
