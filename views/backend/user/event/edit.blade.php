      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br />
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action=" {{$base_url}}/web/event/{{$data->id}}/edit " method="post">
                ...
                <div class="form-group has-feedback">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="date" name="end_date" id="first-end_date" required="required" class="form-control col-md-7 col-xs-12" value="{{ $data->end_date }}" placeholder="Acara selesai">
                  </div>
                        <span class="help-block"></span>
                </div>
