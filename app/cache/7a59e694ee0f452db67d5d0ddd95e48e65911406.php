  ...
  <div class="container">
    ...
    <div class="card horizontal">
      <div class="card-image" style="background: #EEEEEE">
        <a>
            <img src="<?php echo e($session->image); ?>" style="width: 250px;height: 350px">
        </a>
      </div>
      <div class="card-stacked">
        ...
        <?php endif; ?>
          <a  href="<?php echo e($base_url); ?>/web/user/edit/<?php echo e($session->id); ?>/profile">Setting Profile</a>
