    ...
    <div class="card horizontal">
      <div class="card-image" style="background: #EEEEEE">
        <a class="modal-trigger" href="#modal2">
            <img src="<?php echo e($session->image); ?>" style="width: 250px;height: 350px" title="Perbaharui Foto Profile">
        </a>
      </div>
      <div class="card-stacked">
        ...
        <?php endif; ?>
          <a  href="<?php echo e($base_url); ?>/web/user/edit/<?php echo e($session->id); ?>/profile">
  ...
  <span style="float: right;">
    ...
    <div class="col s3 center-align">
        <div id="modal4" class="modal">
          <div class="modal-content">
              <?php if($saldo->status == 400): ?>
                  <p><?php echo e($saldo->error_message); ?></p>
              <?php else: ?>
                  <p><?php echo e($saldo->saldo_deposit); ?></p>
              <?php endif; ?>

          </div>
          <div class="modal-footer">
              <a class="btn btn-default pull-right"
                href="<?php echo e($base_url); ?>/web/deposit/kredit">
