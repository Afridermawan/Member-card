    ...
    <div class="">
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
                <a href="<?php echo e($link.'add'); ?>" class="btn btn-primary">Tambah Artikel </a>
                <div class="clearfix"></div>
            </div>
                  ...
                  <tbody>
                    ...
                    <?php $__currentLoopData = $data->data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e($link.$datas->id.'/update'); ?>" class="btn btn-default btn-sm"><i class="fa fa-edit"></i></a>
