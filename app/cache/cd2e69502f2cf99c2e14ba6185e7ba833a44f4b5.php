                  ...
                  <div class="col s12 m6 offset-m3">
                     <div class="card" style="border-radius: 25px;box-shadow: 2px 2px 4px #000000;background: #fafafa">
                        <div class="card-content">
                           ...
                           <form action="<?php echo e($base_url); ?>/" method="post">
                              <div class="row">
                    ...
                    <div>
                      <p class="pull-right text-xs-center m-0"><a href="<?php echo e($base_url); ?>/form/reset" class="btn red">Lupa Password ?</a></p>
                      <p class="pull-left text-xs-center m-0"><a href="<?php echo e($base_url); ?>/auth/signup" class="btn blue">Daftar Di sini</a></p>
                    </div>
                  </div>
               </div>
            </div>
