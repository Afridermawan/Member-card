<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo e($base_url); ?>/assets/css/maps/jquery-jvectormap-2.0.3.css" />
  <link href="<?php echo e($base_url); ?>/assets/css/icheck/flat/green.css" rel="stylesheet" />
  <link href="<?php echo e($base_url); ?>/assets/css/floatexamples.css" rel="stylesheet" type="text/css" />

  <script src="<?php echo e($base_url); ?>/assets/js/jquery.min.js"></script>
  <script src="<?php echo e($base_url); ?>/assets/js/nprogress.js"></script>
